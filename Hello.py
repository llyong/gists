...
# 创建侧边栏选项
options = ['Nomogram Models for Prognostic Prediction in Gastric Gas-trointestinal Stromal Tumors New Insights from a Global Real-World Cohort Study','seer1 GISTs', 'seer2 GISTs', 'Pie Chart']
...
# 根据选择展示不同的图表
if selected_option == 'Nomogram Models for Prognostic Prediction in Gastric Gas-trointestinal Stromal Tumors New Insights from a Global Real-World Cohort Study':
